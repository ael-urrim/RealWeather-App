  ...
  return (
    <div className="home">
      <div className="home-body">
        <div className="title">
          <h2>Welcome to Real Weather App</h2>
        </div>
	...
	c19.662,0,35.656-15.996,35.656-35.656C149.56,78.432,135.888,63.401,118.294,61.231z"
        ...
        <Link to="/search-location" className="get-started">
          Check Weather
        </Link>
      </div>
      ...
      <div className="key-features">
        ...
        <div className="feature-one">
          ...
          <p>
            Users can check the weather condition of a city by entering the city
            and country name in the provided input fields.
          </p>
        </div>
        ...
        <div className="body">
          ...
          <p>
            <ul>
              <li>
                LinkedIn:{" "}
                <Link to="https://www.linkedin.com/in/samuel-obanijesu-86b272212/" className="link">
                  LinkedIn page
                </Link>
              </li>
              <li>
              ...
              <li>
                Project Github repo:{" "}
                <Link to="https://github.com/ael-urrim/RealWeather-App" className="link">
                  Project repo
                </Link>
              </li>
            </ul>
